...
We regret to inform you that we are unable to proceed with the submission for Parsian Evin Hotel Ltd. (reference: SUB-2023-010) due to compliance issues.
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <SummaryCard title="Total Checks" value="26" icon={Shield} iconClassName="bg-light-blue text-sky-blue" />
        <SummaryCard
          title="Non-Compliant"
          value="5"
          icon={XCircle}
