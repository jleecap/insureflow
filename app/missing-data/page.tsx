...
const mockSubmissions: Submission[] = [
  {
    ...
    emailDraft: `Dear ABC Insurance Brokers,

We are reviewing the submission for GreenTech Solutions Ltd. (reference: SUB-2023-001) and require some additional information to proceed with the quotation process.
...
export default function MissingDataCheckPage() {
