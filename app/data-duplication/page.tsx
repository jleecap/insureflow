...
We have identified that the submission for Global Manufacturing (reference: SUB-2023-007) appears to be a duplicate of an existing submission in our system (reference: SUB-2023-002) submitted by Risk Partners on April 15, 2025.
...
InsureFlow Team`,
  },
  {
    ...
    duplicateInfo: {
      ...
      client: "Tech Innovations",
      submissionDate: "16 April 2025",
      broker: "Digital Insurance",
      matchConfidence: 88,
    },
    emailDraft: `Dear Digital Insurance,

We have identified that the submission for Tech Innovations (reference: SUB-2023-008) appears to be a duplicate of an existing submission in our system (reference: SUB-2023-005) submitted by your firm on April 16, 2025.
