...
export type SubmissionStatus = "pending" | "processing" | "approved" | "rejected" | "needs-info"
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => handleFilterChange("extraction")}>Quote Submission</DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleFilterChange("core-data")}>Core Data Check</DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleFilterChange("enrichment")}>Data Enrichment</DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleFilterChange("rank")}>Rank & Reject</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          <Button variant="outline" size="sm" className="gap-1">
          ...
          <TableBody>
            {submissions.map((submission) => (
              ...
              >
                ...
                <TableCell>
                  {submission.stage === "extraction" && "Quote Submission"}
                  {submission.stage === "core-data" && "Core Data Check"}
                  {submission.stage === "enrichment" && "Data Enrichment"}
                  {submission.stage === "rank" && "Rank & Reject"}
                </TableCell>
                <TableCell>
